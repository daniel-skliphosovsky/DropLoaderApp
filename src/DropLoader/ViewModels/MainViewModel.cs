...
using DropLoader.Services.Downloaders;
using DropLoader.Services.Interfaces;

namespace DropLoader.ViewModels;
...
public partial class MainViewModel : ObservableObject
{
    ...
    public string VersionText => $"DropLoader v{AppInfo.Current.VersionString}  |  daniel-skliphosovsky";
